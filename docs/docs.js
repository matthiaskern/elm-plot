...
var _terezka$elm_plot$Internal_Draw$fullLine = F3(
	function (attributes, _p16, value) {
		var _p17 = _p16;
		var _p19 = _p17.toSvgCoords;
		var _p18 = _p17.scale.x;
		var lowest = _p18.lowest;
		var highest = _p18.highest;
		var begin = _p19(
		...
		var attrs = A2(
			_elm_lang$core$Basics_ops['++'],
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$style(
						_terezka$elm_plot$Internal_Draw$toStyle(_p2.style)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$class(
							A2(
								_elm_lang$core$String$join,
								' ',
								{ctor: '::', _0: 'elm-plot__label__default-view', _1: _p2.classes})),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _terezka$elm_plot$Internal_Label$toLabelText = F2(
	function (formatConfig, infos) {
		var _p4 = formatConfig;
		if (_p4.ctor === 'FromFunc') {
			return A2(_elm_lang$core$List$map, _p4._0, infos);
		} else {
			return _p4._0;
		}
	});
var _terezka$elm_plot$Internal_Label$view = F4(
	function (formatConfig, view, wrapView, infos) {
		return A3(
			_elm_lang$core$List$map2,
			wrapView,
			infos,
			A3(
				...
				view,
				infos,
				A2(_terezka$elm_plot$Internal_Label$toLabelText, formatConfig, infos)));
	});
...
var _terezka$elm_plot$Internal_Label$toStyleConfig = A2(
	_elm_lang$core$List$foldl,
	F2(
		function (x, y) {
			return x(y);
...
var _terezka$elm_plot$Internal_Label$defaultViewConfig = _terezka$elm_plot$Internal_Label$defaultView(_terezka$elm_plot$Internal_Label$defaultStyleConfig);
...
var _terezka$elm_plot$Internal_Axis$viewLabel = F5(
	function (meta, config, axisPosition, info, view) {
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A4(_terezka$elm_plot$Internal_Axis$getLabelPosition, meta, config, axisPosition, info)),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							A4(
								...
								_p30.labelFormat,
								_p30.labelView,
								A3(_terezka$elm_plot$Internal_Axis$viewLabel, _p33, _p31, axisPosition),
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {tickConfig: a, tickValues: b, labelView: c, labelFormat: d, labelValues: e, lineConfig: f, orientation: g, anchor: h, cleanCrossings: i, position: j, classes: k};
										};
									};
								};
							};
...
var _terezka$elm_plot$Internal_Axis$defaultConfigX = {
	...
	labelView: _terezka$elm_plot$Internal_Label$defaultViewConfig,
	labelFormat: _terezka$elm_plot$Internal_Label$FromFunc(
		function (_p34) {
			return _elm_lang$core$Basics$toString(
				function (_) {
					return _.value;
...
var _terezka$elm_plot$Plot_Label$formatFromList = function (format) {
	return _terezka$elm_plot$Internal_Label$FromList(format);
};
var _terezka$elm_plot$Plot_Label$format = function (format) {
	return _terezka$elm_plot$Internal_Label$FromFunc(format);
};
var _terezka$elm_plot$Plot_Label$viewCustom = function (toView) {
	return toView;
};
var _terezka$elm_plot$Plot_Label$view = F3(
	function (toStyles, info, text) {
		return A3(
			_terezka$elm_plot$Internal_Label$defaultView,
			_terezka$elm_plot$Internal_Label$toStyleConfig(
				toStyles(info)),
			info,
			text);
	});
...
var _terezka$elm_plot$Plot_Axis$labelFormat = F2(
	function (formatter, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{labelFormat: formatter});
	});
var _terezka$elm_plot$Plot_Axis$labelView = F2(
	function (view, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{labelView: view});
...
var _terezka$elm_plot$Internal_Bars$toLength = F2(
	function (meta, yValue) {
		return (yValue * meta.scale.y.length) / meta.scale.y.range;
	});
var _terezka$elm_plot$Internal_Bars$toStackedCoords = F6(
	function (meta, config, styleConfigs, width, group, info) {
		var _p29 = config.stackBy;
		if (_p29.ctor === 'X') {
			return A2(
				_terezka$elm_plot$Internal_Draw$addDisplacement,
				{
					ctor: '_Tuple2',
					_0: A3(_terezka$elm_plot$Internal_Bars$toXStackedOffset, styleConfigs, width, info),
					_1: 0
				},
				meta.toSvgCoords(
					{
						ctor: '_Tuple2',
						_0: info.xValue,
						_1: A2(_elm_lang$core$Basics$max, 0, info.yValue)
					}));
		} else {
			return A2(
				_terezka$elm_plot$Internal_Draw$addDisplacement,
				{
					...
					_1: A2(
						_elm_lang$core$Basics$min,
						0,
						A2(_terezka$elm_plot$Internal_Bars$toLength, meta, info.yValue))
				},
				meta.toSvgCoords(
					A2(
						_terezka$elm_plot$Internal_Draw$addDisplacement,
						{
							ctor: '_Tuple2',
							_0: 0,
							_1: A2(_terezka$elm_plot$Internal_Bars$toYStackedOffset, group, info)
						},
						{ctor: '_Tuple2', _0: info.xValue, _1: info.yValue})));
		}
	});
var _terezka$elm_plot$Internal_Bars$viewBar = F5(
	function (meta, width, _p30, styleConfig, info) {
		var _p31 = _p30;
		return A2(
...
var _terezka$elm_plot$Internal_Bars$Config = F4(
	function (a, b, c, d) {
		return {stackBy: a, labelView: b, labelFormat: c, maxWidth: d};
	});
...
var _terezka$elm_plot$Plot_Bars$labelFormat = F2(
	function (formatter, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{labelFormat: formatter});
	});
var _terezka$elm_plot$Plot_Bars$labelView = F2(
	function (view, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{labelView: view});
...
var _terezka$elm_plot$Internal_Scale$getScale = F6(
	function (lengthTotal, restrictRange, internalBounds, offset, _p10, values) {
		var _p11 = _p10;
		var boundsNatural = {
			lower: restrictRange.lower(
				_terezka$elm_plot$Internal_Stuff$getLowest(values)),
			upper: restrictRange.upper(
				_terezka$elm_plot$Internal_Stuff$getHighest(values))
		};
		var bounds = A2(_terezka$elm_plot$Internal_Stuff$foldBounds, internalBounds, boundsNatural);
												...
												_1: {
													...
													_1: {
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _terezka$elm_plot$Plot_Axis$labelView(
																	_terezka$elm_plot$Plot_Label$view(
																		_elm_lang$core$Basics$always(_terezka$elm_plot$PlotComposed$labelStyle))),
																_1: {
																	ctor: '::',
																	_0: _terezka$elm_plot$Plot_Axis$labelFormat(
																		_terezka$elm_plot$Plot_Label$format(
																			function (_p8) {
																				var _p9 = _p8;
																				return A2(
																					_elm_lang$core$Basics_ops['++'],
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Axis$labelView(
									_terezka$elm_plot$Plot_Label$view(_terezka$elm_plot$PlotTicks$toLabelStyle)),
								_1: {ctor: '[]'}
							}
						}
					}
		...
		_0: A3(
			_terezka$elm_plot$Plot$bars,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Bars$labelView(
							_terezka$elm_plot$Plot_Label$view(
								_elm_lang$core$Basics$always(
									{
										ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Bars$labelFormat(
								_terezka$elm_plot$Plot_Label$formatFromList(
									{
										ctor: '::',
										_0: 'A',
										_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Axis$labelView(
										_terezka$elm_plot$Plot_Label$view(_terezka$elm_plot$PlotSticky$toLabelAttrsY)),
									_1: {
										ctor: '::',
										_0: _terezka$elm_plot$Plot_Axis$labelFormat(
											_terezka$elm_plot$Plot_Label$format(
